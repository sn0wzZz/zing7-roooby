  ...
  return (
    <nav className='sticky top-0 w-[100vw] z-40 bg-background-main'>
      ...
      >
        ...
        lg:translate-x-0 lg:bg-transparent lg:shadow-none lg:h-auto lg:top-none lg:right-none lg:flex-row lg:items-center lg:relative  lg:w-[70vw] xl:w-[75vw] 2xl:w-[70vw] ultrawide-md:w-[50vw]  ultrawide-lg:w-[45vw] ultrawide-xl:w-[30vw]  lg:justify-between   
        `}
        >
