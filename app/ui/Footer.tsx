...
export default function Footer() {
  return (
    <footer className='p-10 grid grid-cols-1 xl:grid-cols-12 col-span-12'>
      ...
      <div className=' border-t-2 p-2 flex flex-col-reverse items-center md:flex-row md: justify-between col-span-12 xl:col-span-10 xl:col-start-2 text-p-secondary'>
