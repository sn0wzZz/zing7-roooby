...
export default function BottmBanner() {
  return (
    <div className='w-[100vw] bg-f-banner-1 z-0 relative overflow-hidden'>
      <div className='absolute w-[200vw] h-[20vh] md:w-[45vw] md:h-[100vw] bg-f-banner-2 md:-right-[5%]   xl:w-[600px]  2xl:w-[700px] ultrawide-md:right-[0%] full ultrawide-lg:right-[5%] ultrawide-xl:right-[10%]  xl:-right-[5%]  2xl:-right-[5%] bottom-0 md:top-0'></div>

      <div className='absolute w-[70vh] h-[70vh] sm:w-[90vh] sm:h-[90vh] md:w-[50vw] md:h-[100vw] md:-right-[5%] md:top-36  xl:w-[700px]  2xl:w-[900px] bg-f-banner-3 rounded-full xl:-right-[5%]  2xl:-right-[5%] top-72 ultrawide-xl:right-[10%]   ultrawide-md:-right-[5%] ultrawide-lg:right-[5%]  '></div>
