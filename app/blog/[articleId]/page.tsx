  ...
  return (
    <>
      <Container bgColor='bg-background-main' noPadding>
        <Container
          bgColor='bg-background-main pt-10 xl:pt-20 xl:px-20'
          noPadding
        >
      ...
      <Container noPadding>
        <Container>
          <div className='flex flex-col gap-20'>
            <div>
              <p className='text-2xl font-medium'>{article.content.main.pre}</p>
            </div>
            ...
            {article.content.sub&&<div className='flex flex-col gap-10'>
